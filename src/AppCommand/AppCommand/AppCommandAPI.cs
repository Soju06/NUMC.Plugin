...
{
    public static class AppCommandAPI
    {
        ...
        {
            if (handle == null) throw new NullReferenceException("Failed to get the handle");
    ...
    public enum APPCOMMAND
    {
        ...
        /// <summary>
        /// Pause. If already paused, take no further action. This is a direct PAUSE command that has no state. If there are discrete Play and Pause buttons, applications should take action on this command as well as 
        /// </summary>
        APPCOMMAND_MEDIA_PAUSE = 47,
        /// <summary>
        /// Begin playing at the current position. If already paused, it will resume. This is a direct PLAY command that has no state. If there are discrete 
        /// </summary>
